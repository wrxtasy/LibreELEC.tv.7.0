...
PKG_URL=""
PKG_DEPENDS_TARGET="toolchain libressl curl ncurses libtorrent zlib xmlrpc-c rutorrent miniupnpc rtorrent php dtach"
...
addon() {
  ...
  cp -P $(get_build_dir php)/.$TARGET_NAME/sapi/cgi/php-cgi $ADDON_BUILD/$PKG_ADDON_ID/bin/php-cgi
